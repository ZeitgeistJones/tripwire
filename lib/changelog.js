...
export const CHANGELOG = [
  {
    date: "2026-08-20",
    title: "ClawdWire leads with trade flow, not Coverage %",
    bullets: [
      "Net / Buy / Sell stay up top — tagged DEX flow on Base, said in plain language.",
      "Coverage % is no longer on the hero or Flow table (it read like “most trading is missing”).",
      "Honesty numbers live under Flow → Data notes as “tagged share,” with a clear note that fees/hops/sends are not hidden volume.",
    ],
  },
  {
    date: "2026-08-05",
    title: "CLAWD V4 / Clanker buys start counting",
    bullets: [
      "Optional CLAWD V4 gap-fill MV can feed Buy/Sell/Net (estimate). Pulse stays on dex.trades until you uncomment the UNION — so Trip doesn’t break if the MV isn’t live.",
      "Coverage % / Accounted / Unclassified across 15m–24h are honesty bounds, not a claim of total volume.",
      "Other Trip tokens stay on dex.trades only for now.",
    ],
  },
  {
    date: "2026-08-02",
  ...
  },
  {
    ...
    bullets: [
      ...
      "ClawdWire shows 24h coverage % — how much transfer $ we could attribute to a known DEX trade vs unclassified.",
