...
export const CHANGELOG = [
  {
    ...
    bullets: [
      "CLAWD hooked Uniswap V4 fills can now feed Buy/Sell/Net via a separate Dune materialized view (estimate, not a full decoder).",
      "Coverage % / DEX accounted / Unclassified still show honesty bounds across 15m–24h; V4 fills raise accounted when the MV is live.",
