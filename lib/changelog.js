...
export const CHANGELOG = [
  {
    date: "2026-08-01",
    title: "ClawdWire — matched VWAP closed PnL (Chunk I)",
    bullets: [
      "Adds data-backed closed PnL: matched tokens = min(buy, sell) in-window; PnL = matched × (sell VWAP − buy VWAP) from DEX trade $ and amounts.",
      "Shows winner/loser counts, gains/losses $, and top closed winners/losers — separate from net flow (red net ≠ more losers).",
