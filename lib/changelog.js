...
export const CHANGELOG = [
  {
    date: "2026-08-02",
    title: "Freshness-first ClawdWire",
    bullets: [
      "Home opens ClawdWire; multi-token tables sit under Snapshot with a clear stale/snapshot badge.",
      "Pulse age is loud on the cockpit (hero + rail); Trip cooldown is 15 minutes per token, not 1 hour.",
    ],
  },
  {
    date: "2026-08-01",
    title: "ClawdWire gated to Tripwire holder wallets",
    bullets: [
      "Trip / Sync / latest APIs accept the same on-chain hasAccess gate as the dashboard (plus the legacy tester wallet).",
      "Fixes ClawdWire buttons failing with tester-only 403 when a normal holder wallet was connected.",
    ],
  },
  {
    date: "2026-08-01",
    title: "ClawdWire — matched trade results + tax-safe labeling",
    bullets: [
      "Matched VWAP results use clear trade $ / token amounts (min buy/sell match) — research heuristic, separate from net flow.",
      "UI labels avoid tax language (no “realized gains” framing); explicit not-for-tax / not-advice disclaimer on the section.",
      "Re-paste docs/dune-CLAWDWIRE-paste-this.sql into Dune 8180604 if columns are missing (no trailing semicolon).",
    ],
  },
  {
    date: "2026-08-01",
    title: "ClawdWire admin share prompt + softer trade-shape labels",
    bullets: [
      "Admin → Copy ClawdWire prompt builds a social-image brief from the live pulse (same style as Whale/Buyers cards).",
      "UI/SQL labels: “wash” → “round-trip” / “trade-shape signals” — research heuristics, not accusations.",
    ],
  },
  {
    date: "2026-08-01",
    title: "ClawdWire — run-up & dump hour wallets (Chunk H2)",
    bullets: [
      "Top buyers/sellers + nets for the run-up window (hour before peak + peak hour) and the worst dump hour.",
      "Answers “who bought the rip / who sold the dump” with Basescan links — same 30d scan.",
      "Re-paste docs/dune-CLAWDWIRE-paste-this.sql into Dune 8180604 (no trailing semicolon).",
    ],
  },
  {
    date: "2026-08-01",
    title: "ClawdWire — timing tape vs price peak (Chunk H)",
    bullets: [
      "Adds peak trade-price hour and nets before/at/after that hour (total + whale), plus best/worst net hours.",
      "Hourly net + whale tapes (24h, UTC) so a CG spike can be lined up with who flowed when — same 30d scan, no new tables.",
      "Re-paste docs/dune-CLAWDWIRE-paste-this.sql into Dune 8180604 (no trailing semicolon).",
    ],
  },
  {
    date: "2026-07-31",
    title: "ClawdWire — fingerprints + conviction (Chunk G)",
    bullets: [
      "Trade-shape signals: size uniformity, size CV, vol-per-1% move, impact %/$1k, round-trip vol % (3+ short-window pairs), buy/sell streaks.",
      "Conviction: diamond-hand survival % at 1h/1d/3d/7d for first buyers, plus median minutes-to-flip (new vs returning).",
      "Labeled as estimated/suspected — re-paste docs/dune-CLAWDWIRE-paste-this.sql into Dune 8180604 (no trailing semicolon).",
    ],
  },
  {
    date: "2026-07-31",
