...
export function buildClawdWireCardPrompt(wireRow, dashRow = null, meta = {}) {
  ...
  const pulseAsOf = meta.clawdWireLastRunAt
    ? new Date(meta.clawdWireLastRunAt).toISOString()
  ...
  return [
    ...
    "- If those fields appear in DATA, label them \"research heuristic / not for tax\" and do not invent tax implications.",
    "",
    "=== PLAIN DEFINITIONS (1–2 lines on the card) ===",
