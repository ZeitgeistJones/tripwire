...
export function buildWhaleCardPrompt(row, period = "7d", meta = {}) {
  ...
  return [
    ...
    multi
      ? "2. TWO BANDS or columns — 24h and 7d — each with large-wallet net flow as the hero number for that band."
...
export function buildAllCardPrompt(row, period = "all", meta = {}) {
  ...
  return [
    ...
    "3. Keep labels plain English. Do not invent missing windows or ratios.",
    "4. Snapshot time + disclaimer.",
